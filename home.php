...
?>
            ...
            <div class="hero__items set-bg" data-setbg="<?php echo $row['image'];  ?>">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                <h6><?php echo $row['h6'];  ?></h6>
...
?>
                        ...
                        <div class="instagram__pic__item set-bg" data-setbg="<?php echo $row['image'];?>"></div>
                        <?php
}
?>
...
?>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="<?php echo $row['image'];  ?>"></div>
